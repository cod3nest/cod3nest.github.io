...
tags: ['Due Diligence', 'Fundraising', 'Technical Leadership']
---
...
1. **Conduct a self-assessment** using this checklist
2. **Document your architecture** if you haven't already
3. **Clean up obvious issues** (security vulnerabilities, broken CI)
4. **Prepare honest answers** about technical debt

### 2-4 Weeks Before

1. **Create a technical overview document** (2-3 pages max)
2. **Prepare architecture diagrams** (even if imperfect)
3. **Gather metrics** (uptime, deployment frequency, test coverage)
4. **Brief your technical team** on what to expect

### 1 Week Before

1. **Ensure repo access** is ready to grant
2. **Prepare a demo environment** if needed
3. **Identify who will answer which questions**
4. **Review this checklist one more time**

## Common Mistakes to Avoid

**1. Hiding problems**
Investors will find issues. It's better to acknowledge them upfront with a remediation plan than to be caught hiding them.

**2. Over-engineering for the review**
Don't suddenly add tests or documentation just for due diligence. Investors can tell the difference between genuine practices and performance art.

**3. Having no technical representation**
If you're a non-technical founder, have someone credible (fractional CTO, technical advisor) in due diligence meetings.

**4. Being unable to explain your own technology**
You don't need to write code, but you should understand your architecture well enough to explain it clearly.

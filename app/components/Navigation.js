        ...
        <div className="flex justify-between items-center h-20">
          ...
          <div className="hidden md:block">
            <div className="ml-10 flex items-baseline space-x-1">
              ...
              <a href="#approach" className="text-slate-700 hover:text-sky-700 px-4 py-2 text-sm font-medium transition-colors rounded-xl hover:bg-slate-50">How We Work</a>
              <a href="#about" className="text-slate-700 hover:text-sky-700 px-4 py-2 text-sm font-medium transition-colors rounded-xl hover:bg-slate-50">About</a>
              <a href="#contact" className="bg-gradient-to-r from-sky-600 to-cyan-500 text-white px-6 py-2.5 ml-2 rounded-xl text-sm font-semibold hover:from-sky-700 hover:to-cyan-600 transition-all shadow-sm hover:shadow">Contact</a>
            </div>
          </div>
        ...
        {isMenuOpen && (
          <div className="md:hidden">
            <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3 bg-white border-t border-slate-100">
              ...
              <a href="#approach" className="text-slate-700 hover:text-sky-700 block px-3 py-2 text-base font-medium rounded-lg hover:bg-slate-50">How We Work</a>
              <a href="#about" className="text-slate-700 hover:text-sky-700 block px-3 py-2 text-base font-medium rounded-lg hover:bg-slate-50">About</a>
              <a href="#contact" className="text-sky-700 font-semibold block px-3 py-2 text-base">Contact</a>
            </div>
          </div>
        )}
      </div>
